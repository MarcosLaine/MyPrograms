...
function getDiasLimitesMes(data){
    /*Essa função retornará um objeto com duas propriedades: primeiro e ultimo, sendo primeiro o primeiro dia a aparecer no calendario e ultimo o ultimo. O calendario mostra 35 dias nele. O calendario começa no primeiro domingo e vai até o sábado do final do calendario. A primeira linha do calendario sempre apresentará o primeiro dia do mês*/
...
function showUnavailableDays(){
    //se o dia for menor que o dia atual, ele não pode ser selecionado
