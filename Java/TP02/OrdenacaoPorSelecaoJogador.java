...
public class OrdenacaoPorSelecaoJogador {
    ...
    public String toString() {
        return "[" + id + " ## " + (name.isEmpty() ? "nao informado" : name) + " ## " + weight + " ## " + height + " ## " + (ondeEstudou.isEmpty() ? "nao informado" : ondeEstudou) + " ## " + anoNasc + " ## " + (estadoNasc.isEmpty() ? "nao informado" : estadoNasc) + " ## " + (cidadeNasc.isEmpty() ? "nao informado" : cidadeNasc) + "]";
    }
    ...
    /* A função a seguir cria o arquivo log para salvar os dados pedidos */
